...
class Exceptions
{
    public static T[] Subsequence<T>(T[] arr, int startIndex, int count)
    {
        ...
        {
            throw new ArgumentOutOfRangeException("The subsequence is not inside the arrays range.");
        }
    ...
    public static string ExtractEnding(string str, int count)
    {
        if (count > str.Length)
        {
            throw new ArgumentException("Count must not exceed the string length.");
        }
